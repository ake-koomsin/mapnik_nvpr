...
int main ( int argc , char** argv)
{
    ...
    try {
        ...
        feature_type_style shield_style;
        rule shield_rule;
        shield_symbolizer ss(parse_expression("[GEONAME]"), "DejaVu Sans Bold", 10, color(0, 0, 0),parse_path("tru_shield8.png"));
        shield_rule.append(ss);
        shield_style.add_rule(shield_rule);
        m.insert_style("shield",shield_style);
