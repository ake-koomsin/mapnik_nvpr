...
int main ( int argc , char** argv)
{
    ...
    try {
        ...
        // m.set_background(color(0,0,0,0));
        ...
        // rule provpoly_rule_on;
        // provpoly_rule_on.set_filter(parse_expression("[NAME_EN] = 'Ontario'"));
        // provpoly_rule_on.append(polygon_symbolizer(color(217, 235, 203)));
        // provpoly_style.add_rule(provpoly_rule_on);

        // rule provpoly_rule_qc;
        // provpoly_rule_qc.set_filter(parse_expression("[NOM_FR] = 'Québec'"));
        // provpoly_rule_qc.append(polygon_symbolizer(color(250, 0, 0)));
        // provpoly_style.add_rule(provpoly_rule_qc);
        ...
        polygon_symbolizer poly = polygon_symbolizer(color(153, 204, 255, 150));
        // poly.set_comp_op(multiply);
        qcdrain_rule.append(poly);
        // qcdrain_rule.append(polygon_symbolizer(color(200, 0, 0, 150)));
        qcdrain_style.add_rule(qcdrain_rule);
        // qcdrain_style.set_comp_op(multiply);
        ...
        stroke roads34_rule_stk(color(171,158,137, 125),2.0);
        ...
        // roads34_style.set_comp_op(multiply);
        ...
        stroke roads2_rule_stk_1(color(171,158,137, 125),4.0);
        ...
        // roads2_style_1.set_comp_op(multiply);
        ...
        stroke roads2_rule_stk_2(color(255,250,115, 125),2.0);
        ...
        // roads2_style_2.set_comp_op(multiply);
        ...
        stroke roads1_rule_stk_1(color(188,149,28, 125),7.0);
        ...
        // roads1_style_2.set_comp_op(multiply);
        ...
        rule popplaces_rule;
        text_symbolizer popplaces_text_symbolizer(parse_expression("[GEONAME]"),"DejaVu Sans Bold",10,color(0,0,0));
